...
function (_React$Component) {
  ...
  function Snowfall(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "canvasRef", void 0);

    _defineProperty(_assertThisInitialized(_this), "snowflakes", []);

    _defineProperty(_assertThisInitialized(_this), "snowflakeCount", void 0);

    _defineProperty(_assertThisInitialized(_this), "snowflakeConfig", void 0);

    _defineProperty(_assertThisInitialized(_this), "lastUpdate", void 0);
    ...
    _defineProperty(_assertThisInitialized(_this), "loop", function () {
      if (_assertThisInitialized(_this)) {
