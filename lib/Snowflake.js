...
var Snowflake = function Snowflake(canvas, config) {
  var _this = this;
  ...
  _defineProperty(this, "updateData", function () {
    _this.params.x = (0, _utils.random)(0, _this.canvas.offsetWidth);
    _this.params.y = (0, _utils.random)(-_this.canvas.offsetHeight, 0);
  });
  ...
  _defineProperty(this, "draw", function () {
    ...
    _this.ctx.arc(_this.params.x, _this.params.y, _this.params.radius, 0, 2 * Math.PI);

    _this.ctx.fillStyle = _this.params.color;
  ...
  _defineProperty(this, "onDown", function () {
    if (_this.params.y < _this.canvas.offsetHeight) {
      return;
    }
  ...
  this.canvas = canvas;
  this.ctx = canvas.getContext('2d'); // Merging input config with default config
  ...
  this.params = {
    color: color,
    x: (0, _utils.random)(0, this.canvas.offsetWidth),
    y: (0, _utils.random)(-this.canvas.offsetHeight, 0),
